...
wget https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.112/bin/apache-tomcat-9.0.106.tar.gz
...
sed -i '59  a\</tomcat-users>' apache-tomcat-9.0.1o6/conf/tomcat-users.xml
